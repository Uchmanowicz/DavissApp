...
void DatabaseManager::createUsersTable()
{
	QString sql(QString("CREATE TABLE IF NOT EXISTS "
							...
							"%9 blob"
							");")
			.arg(UserTable::TABLE_NAME, UserTable::LOGIN, UserTable::PASSWORD, UserTable::NAME, UserTable::ROLE,
					 UserTable::MODULES, UserTable::IS_BLOCKED, UserTable::IsAlwaysLogged, UserTable::AVATAR));
